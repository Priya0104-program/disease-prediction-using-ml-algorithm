...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor Application using 3 ML Algorithms", fg="white", bg="blue")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by Andrew Pappas©️", fg="white", bg="blue")
